...
exports.CreateQuotes1718000007000 = void 0;
const typeorm_1 = require("typeorm");
class CreateQuotes1718000007000 {
    async up(q) {
        ...
        await q.createIndex('quotes', new typeorm_1.TableIndex({ name: 'idx_quotes_status', columnNames: ['status'] }));
        await q.createIndex('quotes', new typeorm_1.TableIndex({ name: 'idx_quotes_project_id', columnNames: ['project_id'] }));
        await q.createIndex('quotes', new typeorm_1.TableIndex({ name: 'idx_quotes_customer_id', columnNames: ['customer_id'] }));
        await q.createForeignKey('quotes', new typeorm_1.TableForeignKey({
...
exports.CreateQuotes1718000007000 = CreateQuotes1718000007000;
//# sourceMappingURL=1718000007000-CreateQuotes.js.map