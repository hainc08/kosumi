...
const query_worker_dto_1 = require("./dto/query-worker.dto");
let WorkersController = class WorkersController {
    ...
    setStatus(id, status) { return this.svc.setStatus(id, status); }
...
__decorate([
    ...
    __metadata("design:paramtypes", [query_worker_dto_1.QueryWorkerDto]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], WorkersController.prototype, "setStatus", null);
__decorate([
