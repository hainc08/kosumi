...
exports.CreateTimesheetEntries1718000012000 = void 0;
const typeorm_1 = require("typeorm");
class CreateTimesheetEntries1718000012000 {
    async up(q) {
        ...
        await q.createIndex('timesheet_entries', new typeorm_1.TableIndex({ name: 'uq_timesheet_worker_date', columnNames: ['worker_id', 'work_date'], isUnique: true }));
        await q.createIndex('timesheet_entries', new typeorm_1.TableIndex({ name: 'idx_timesheet_worker', columnNames: ['worker_id'] }));
        await q.createForeignKey('timesheet_entries', new typeorm_1.TableForeignKey({
...
exports.CreateTimesheetEntries1718000012000 = CreateTimesheetEntries1718000012000;
//# sourceMappingURL=1718000012000-CreateTimesheetEntries.js.map